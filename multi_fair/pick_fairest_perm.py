...
def pick_fairest_perm(ranks, group_info, pthres, ithres, inter_given):
    """   A function for finding the fair consensus ranking 
                :param ranks: A numpy array of base rankings, rows = rankings, col = candidates
                :param group_info: A numpy array of group_info[0] = candidate ids, and row vectors for each protected attribute's group labels, assume intersection is last attribute
